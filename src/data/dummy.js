...
export const OUTLIER_DURASI = {
  ...
  outliers: [
    { value: 310, id:'SE26-1142', nama:'Rusli Pohan',       kec:'Dolok Sigompulon',      desa:'Aek Buru',     pcl:'Dapid Harahap',    status:'SUBMITTED' },
    { value: 395, id:'SE26-0980', nama:'Yusniar Hasibuan',  kec:'Hulu Sihapas',          desa:'Sihapas',      pcl:'Asrin Nasution',   status:'SUBMITTED' },
    { value: 450, id:'SE26-1203', nama:'Hotma Sari Daulay', kec:'Padang Bolak Julu',     desa:'Pinarik',      pcl:'Bulan P. Harahap', status:'SUBMITTED' },
    { value: 520, id:'SE26-1356', nama:'Burhanuddin Lubis', kec:'Ujung Batu',            desa:'Langkimat',    pcl:'Ria Asnita',       status:'SUBMITTED' },
    { value: 576, id:'SE26-0712', nama:'Saripuddin Rambe',  kec:'Dolok',                 desa:'Pinarik',      pcl:'Hajarul A. Rambe', status:'SUBMITTED' },
    { value: 638, id:'SE26-0845', nama:'Mawar Lina Srg',    kec:'Dolok Sigompulon',      desa:'Sihapas',      pcl:'Dapid Harahap',    status:'SUBMITTED' },
    { value: 700, id:'SE26-1488', nama:'Marwan Siregar',    kec:'Padang Bolak Tenggara', desa:'Sipiongot',    pcl:'Solehuddin Srg',   status:'SUBMITTED' },
    { value: 758, id:'SE26-0201', nama:'Kholil Harahap',    kec:'Batang Onang',          desa:'Batu Gana',    pcl:'Solehuddin Srg',   status:'SUBMITTED' },
  ],
...
export const OUTLIER_PENDAPATAN = {
  ...
  outliers: [
    { value: 180,  id:'SE26-0560', nama:'Asmara Wati Srg',  kec:'Simangambat',  desa:'Sigama',         usaha:'Perkebunan kelapa sawit', pcl:'Taslim Harahap',   status:'APPROVED'  },
    { value: 240,  id:'SE26-0732', nama:'Bahrum Daulay',    kec:'Portibi',      desa:'Sipiongot',      usaha:'Perdagangan eceran',      pcl:'Bulan P. Harahap', status:'SUBMITTED' },
    { value: 350,  id:'SE26-0891', nama:'Eli Saputri Hrp',  kec:'Padang Bolak', desa:'Tanjung Morang', usaha:'Restoran Padang',         pcl:'Zainal Sagala',    status:'APPROVED'  },
    { value: 480,  id:'SE26-0019', nama:'Saripa Harahap',   kec:'Batang Onang', desa:'Sihapas',        usaha:'Kebun sawit',             pcl:'Dapid Harahap',    status:'APPROVED'  },
    { value: 650,  id:'SE26-1024', nama:'Riswan Nasution',  kec:'Halongonan',   desa:'Langkimat',      usaha:'Toko bahan bangunan',     pcl:'Iwan',             status:'SUBMITTED' },
    { value: 900,  id:'SE26-1187', nama:'Husna Rambe',      kec:'Dolok',        desa:'Pinarik',        usaha:'Perkebunan karet',        pcl:'Hajarul A. Rambe', status:'SUBMITTED' },
    { value: 1200, id:'SE26-1305', nama:'Junaidi Pulungan', kec:'Ujung Batu',   desa:'Tanjung Morang', usaha:'Distributor sembako',     pcl:'Ria Asnita',       status:'SUBMITTED' },
    { value: 6300, id:'SE26-0004', nama:'Nurhasanah',       kec:'Batang Onang', desa:'Batu Gana',      usaha:'Kebun karet',             pcl:'Dapid Harahap',    status:'SUBMITTED' },
  ],
...
export const OUTLIER_JUMLAK_AK = {
  ...
  outliers: [
    { value: 13, id:'SE26-1410', nama:'Bahrum Tanjung',    kec:'Padang Bolak',     desa:'Tanjung Morang', pcl:'Zainal Sagala',    status:'SUBMITTED' },
    { value: 14, id:'SE26-1532', nama:'Khairani Hasibuan', kec:'Simangambat',      desa:'Sigama',         pcl:'Taslim Harahap',   status:'SUBMITTED' },
    { value: 15, id:'SE26-1648', nama:'Sahminan Rambe',    kec:'Dolok',            desa:'Pinarik',        pcl:'Hajarul A. Rambe', status:'SUBMITTED' },
    { value: 17, id:'SE26-1750', nama:'Robiah Daulay',     kec:'Portibi',          desa:'Sipiongot',      pcl:'Bulan P. Harahap', status:'APPROVED'  },
    { value: 19, id:'SE26-1822', nama:'Patimah Siregar',   kec:'Halongonan',       desa:'Langkimat',      pcl:'Iwan',             status:'SUBMITTED' },
    { value: 22, id:'SE26-0012', nama:'Ridwan Siregar',    kec:'Halongonan Timur', desa:'Sigama',         pcl:'Ria Asnita',       status:'SUBMITTED' },
  ],
